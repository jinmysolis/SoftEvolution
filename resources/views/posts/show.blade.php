...
<article class="post image-w-text container">
     @if($post->photos->count() === 1)
                    <figure><img src="{{ $posts->photos->first()->url }}" alt="" class="img-responsive"></figure>
                 @endif
        ...
        <footer class="container-flex space-between">
          <div class="buttons-social-media-share">
            <ul class="share-buttons">
              <li><a href="https://www.facebook.com/sharer/sharer.php?ur&t=" title="Share on Facebook" target="_blank"><img alt="Share on Facebook" src="{{ asset('img/flat_web_icon_set/Facebook.png') }}"></a></li>
