		...
		<article class="post ">
			...
			<div class="content-post">
				<header class="container-flex space-between">
					<div class="date">
						<span class="c-gray-1">{{$posts->published_at->format('M d ')}}</span>
					</div>
					<div class="post-category">
						<span class="category text-capitalize">{{$posts->category->name}}</span>
					</div>
				</header>
				<h1>{{$posts->title}}.</h1>
				...
				<footer class="container-flex space-between">
					<div class="read-more">
						<a href="blog/{{$posts->id}}" class="text-uppercase c-green">Leer mas</a>
					</div>
